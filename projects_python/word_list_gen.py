...
# goal is to add this to a larger program or 'object' 
...
## input txt to be replaced with input from website/app ##
    ...
    txt += '''they will not save you if you are hated by the people. '''
    txt += '''DEATH CAME FOR him wearing a smile '''
    ...
    word_list = [i for i in new_list if len(i) >= 4 and len(i) < 10]
    
    #return finished list
    return(word_list)

test = build_word_list('')
print(test)
